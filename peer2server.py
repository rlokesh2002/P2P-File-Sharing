...
def create_socket():
    try:
        ...
        host = ""
        server_port = 4060 #peer1 server port numbers
    ...
    while True:
        ...
        if re.findall('^file_inquiry', client_response):
            ...
            if len(file_path) > 0:
               ...
               s.sendto(str.encode("1%s" % str_chunk),
                        client_address)  # Send reponse to client. 1 prefix says that this is the last string left
